...
/* cookie Extraction */
export const tokenExtraction = (req) => {
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="center" valign="top" style="padding: 36px 24px;">
                                <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                                    <img src="cid:logo" alt="Logo" border="0" width="48"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td align="left" bgcolor="#ffffff"
                                ...
                                <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or
                                    concerns about your order, please <a href="coderdost@gmail.com">contact us</a>.</p>
                            </td>
                        </tr>
                        <!-- end copy -->
                        ...
                        <tr>
                            <td align="left" bgcolor="#ffffff"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td align="left" bgcolor="#D2C7BA" width="60%"
            ...
            <tr>
                <td align="center" bgcolor="#D2C7BA" valign="top" width="100%">
                    <!--[if (gte mso 9)|(IE)]>
                <table align="center" border="0" cellpadding="0" cellspacing="0" widths="600">
                <tr>
                <td align="center" valign="top" width="600">
                <![endif]-->
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td align="center" bgcolor="#D2C7BA"
                                ...
                                <p style="margin: 0;">You received this email because we received a request for order you just created on SHOPEX for your account. If you didn't order thid you can safely
                                    delete this email.</p>
                            </td>
                        </tr>
                        <!-- end permission -->
